...
public class SmokeTest extends AbstractBaseTest {
    ...
    public void smokeTest01(String component, String expectedPageSubTile){
        extentTest = extentReports.createTest("Verify "+component);
        LoginPage loginPage = new LoginPage();
        loginPage.login();
        loginPage.navigateTo(component);
        Assert.assertEquals(loginPage.getPageSubtitleText(),expectedPageSubTile);
    ...
    public Object[][] smokeTestData(){
        return new Object[][]{{"View all orders", "List of All Orders"},
